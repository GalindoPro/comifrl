            ...
            <div className="container mx-auto px-4 space-y-8">
                <div className="text-center">
                    <motion.h3
                        ...
                        viewport={{ once: true }}
                        className="text-3xl md:text-4xl font-black text-white tracking-tighter uppercase mb-4"
                    >
                ...
                <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
                    {[
                        { val: 100, label: "Aportación Interna", icon: <Wallet className="w-8 h-8 text-brand-blue" />, color: "text-brand-blue", bg: "bg-brand-mustard", labelColor: "text-brand-blue" },
